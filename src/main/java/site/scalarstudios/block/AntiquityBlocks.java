...
public class AntiquityBlocks {
    ...
    // Olive Wood
    public static final DeferredBlock<RotatedPillarBlock> OLIVE_LOG = registerBlock(
        "olive_log",
        RotatedPillarBlock::new,
        logProperties(MapColor.WOOD, MapColor.PODZOL, SoundType.WOOD)
    );
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_OLIVE_LOG = registerBlock(
        "stripped_olive_log",
        RotatedPillarBlock::new,
        logProperties(MapColor.WOOD, MapColor.WOOD, SoundType.WOOD)
    );
    public static final DeferredBlock<RotatedPillarBlock> OLIVE_WOOD = registerBlock(
        "olive_wood",
        RotatedPillarBlock::new,
    ...
    public static final DeferredBlock<RotatedPillarBlock> STRIPPED_OLIVE_WOOD = registerBlock(
        "stripped_olive_wood",
        RotatedPillarBlock::new,
        BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F).sound(SoundType.WOOD).ignitedByLava()
    );
    public static final DeferredBlock<Block> OLIVE_PLANKS = registerBlock(
        "olive_planks",
        properties -> properties.mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava()
    );
    public static final DeferredBlock<SaplingBlock> OLIVE_SAPLING = registerBlock(
        "olive_sapling",
        p -> new SaplingBlock(AntiquityTreeGrowers.OLIVE, p),
    ...
    public static final DeferredBlock<FlowerPotBlock> POTTED_OLIVE_SAPLING = registerBlockOnly(
        "potted_olive_sapling",
        p -> new FlowerPotBlock(() -> (FlowerPotBlock) Blocks.FLOWER_POT, OLIVE_SAPLING::get, p),
        BlockBehaviour.Properties.of().instabreak().noOcclusion().pushReaction(PushReaction.DESTROY)
    );
    public static final DeferredBlock<TintedParticleLeavesBlock> OLIVE_LEAVES = registerBlock(
        "olive_leaves",
        p -> new TintedParticleLeavesBlock(0.01F, p),
        leavesProperties(SoundType.GRASS)
    );
    public static final DeferredBlock<ShelfBlock> OLIVE_SHELF = registerBlockWithItem(
        "olive_shelf",
        ShelfBlock::new,
        BlockBehaviour.Properties.of()
            ...
            .ignitedByLava()
            .strength(2.0F, 3.0F),
        (block, properties) -> new BlockItem(block.get(), properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
    );
    public static final DeferredBlock<StairBlock> OLIVE_STAIRS = registerBlock(
        "olive_stairs",
        p -> new StairBlock(OLIVE_PLANKS.get().defaultBlockState(), p),
    ...
    public static final DeferredBlock<StandingSignBlock> OLIVE_SIGN = registerBlockOnly(
        "olive_sign",
        p -> new StandingSignBlock(AntiquityWoodTypes.OLIVE_WOOD_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
    ...
    public static final DeferredBlock<WallSignBlock> OLIVE_WALL_SIGN = registerBlockOnly(
        "olive_wall_sign",
        p -> new WallSignBlock(AntiquityWoodTypes.OLIVE_WOOD_TYPE, p),
        wallVariant("olive_sign", true)
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollision()
    ...
    static {
        AntiquityItems.ITEMS.registerItem(
            "olive_sign",
            p -> new SignItem(OLIVE_SIGN.get(), OLIVE_WALL_SIGN.get(), p.stacksTo(16).useBlockDescriptionPrefix())
        );
    }

    public static final DeferredBlock<DoorBlock> OLIVE_DOOR = registerBlockWithItem(
        "olive_door",
        p -> new DoorBlock(AntiquityWoodTypes.OLIVE_SET_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .instrument(NoteBlockInstrument.BASS)
            .strength(3.0F)
            ...
            .ignitedByLava()
            .pushReaction(PushReaction.DESTROY),
        (block, properties) -> new DoubleHighBlockItem(block.get(), properties)
    );

    public static final DeferredBlock<CeilingHangingSignBlock> OLIVE_HANGING_SIGN = registerBlockOnly(
        "olive_hanging_sign",
        p -> new CeilingHangingSignBlock(AntiquityWoodTypes.OLIVE_WOOD_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
    ...
    public static final DeferredBlock<WallHangingSignBlock> OLIVE_WALL_HANGING_SIGN = registerBlockOnly(
        "olive_wall_hanging_sign",
        p -> new WallHangingSignBlock(AntiquityWoodTypes.OLIVE_WOOD_TYPE, p),
        wallVariant("olive_hanging_sign", true)
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
            .noCollision()
    ...
    static {
        AntiquityItems.ITEMS.registerItem(
            "olive_hanging_sign",
            p -> new HangingSignItem(OLIVE_HANGING_SIGN.get(), OLIVE_WALL_HANGING_SIGN.get(), p.stacksTo(16).useBlockDescriptionPrefix())
        );
    }

    public static final DeferredBlock<FenceBlock> OLIVE_FENCE = registerBlock(
        "olive_fence",
        FenceBlock::new,
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
    ...
    public static final DeferredBlock<FenceGateBlock> OLIVE_FENCE_GATE = registerBlock(
        "olive_fence_gate",
        p -> new FenceGateBlock(AntiquityWoodTypes.OLIVE_WOOD_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
    ...
    public static final DeferredBlock<SlabBlock> OLIVE_SLAB = registerBlock(
        "olive_slab",
        SlabBlock::new,
        BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).instrument(NoteBlockInstrument.BASS).strength(2.0F, 3.0F).sound(SoundType.WOOD).ignitedByLava()
    );
    public static final DeferredBlock<TrapDoorBlock> OLIVE_TRAPDOOR = registerBlock(
        "olive_trapdoor",
        p -> new TrapDoorBlock(AntiquityWoodTypes.OLIVE_SET_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .instrument(NoteBlockInstrument.BASS)
            .strength(3.0F)
    ...
    public static final DeferredBlock<ButtonBlock> OLIVE_BUTTON = registerBlock(
        "olive_button",
        p -> new ButtonBlock(AntiquityWoodTypes.OLIVE_SET_TYPE, 30, p),
        BlockBehaviour.Properties.of().noCollision().strength(0.5F).pushReaction(PushReaction.DESTROY)
    );
    public static final DeferredBlock<PressurePlateBlock> OLIVE_PRESSURE_PLATE = registerBlock(
        "olive_pressure_plate",
        p -> new PressurePlateBlock(AntiquityWoodTypes.OLIVE_SET_TYPE, p),
        BlockBehaviour.Properties.of()
            .mapColor(MapColor.WOOD)
            .forceSolidOn()
            .instrument(NoteBlockInstrument.BASS)
    ...
    private static BlockBehaviour.Properties wallVariant(String standingBlockName, boolean copyName) {
        ...
        BlockBehaviour.Properties properties = BlockBehaviour.Properties.of()
            .overrideLootTable(Optional.of(ResourceKey.create(Registries.LOOT_TABLE, standingId.withPrefix("blocks/"))));
        if (copyName) {
    ...
    private static <T extends Block> DeferredBlock<T> registerBlockWithItem(
        String name, Function<BlockBehaviour.Properties, T> function, BlockBehaviour.Properties properties, BiFunction<DeferredBlock<T>, Item.Properties, Item> itemFactory
    ) {
